...
public class HarmonicaFavouriteViewHolder extends RecyclerView.ViewHolder {
    ...
    private HarmonicaFavouriteViewHolder(View itemView) {
        super(itemView);
    ...
    public static HarmonicaFavouriteViewHolder create(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cart_item_harmonica, parent, false);
        return new HarmonicaFavouriteViewHolder(view);
    }
}
