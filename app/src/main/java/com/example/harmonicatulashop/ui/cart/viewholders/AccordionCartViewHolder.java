...
public class AccordionCartViewHolder extends RecyclerView.ViewHolder {
    ...
    public AccordionCartViewHolder(View itemView) {
        super(itemView);
    ...
    public static AccordionCartViewHolder create(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cart_item_accordion, parent, false);
        return new AccordionCartViewHolder(view);
    }
}
