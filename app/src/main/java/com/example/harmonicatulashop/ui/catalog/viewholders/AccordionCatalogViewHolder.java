...
public class AccordionCatalogViewHolder extends RecyclerView.ViewHolder {
    ...
    public AccordionCatalogViewHolder(View itemView) {
        super(itemView);
    ...
    public static AccordionCatalogViewHolder create(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.catalog_item_accordion, parent, false);
        return new AccordionCatalogViewHolder(view);
    }
}
