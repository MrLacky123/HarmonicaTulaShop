...
public class HarmonicaCatalogViewHolder extends RecyclerView.ViewHolder {
    ...
    private HarmonicaCatalogViewHolder(View itemView) {
        super(itemView);
    ...
    public static HarmonicaCatalogViewHolder create(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.catalog_item_harmonica, parent, false);
        return new HarmonicaCatalogViewHolder(view);
    }
}
