...
public class BayanCartViewHolder extends RecyclerView.ViewHolder {
    ...
    public BayanCartViewHolder(View itemView) {
        super(itemView);
    ...
    public static BayanCartViewHolder create(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cart_item_bayan, parent, false);
        return new BayanCartViewHolder(view);
    }
}
